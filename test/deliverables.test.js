...
function tmpWorkspace() {
  ...
  const docsDir = path.join(workspace, 'TenantOne', 'work-tasks');
...
test('collect() finds a linked deliverable inside the declared roots and reports a missing link as dead', () => {
  ...
  const bag = deliv.collect({ ID: 'T1', TITLE: 'x', DELIVERABLE: `${rel} | TenantOne/work-tasks/does-not-exist.md` }, { workspace });
