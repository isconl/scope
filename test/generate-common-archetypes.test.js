...
const BRIEF = {
  subject_id: 'site-alpha-mailbox', audience: 'alex', title: 'Mailbox Provisioning Brief',
  date_readable: '17 Aug 2026', version: '1.0.0', author: 'Architect',
  decision_ask: 'Approve the mailbox provisioning plan for SITE-ALPHA staff.',
  context_paragraphs: ['SITE-ALPHA needs provisioned mailboxes ahead of the September rollout.'],
  ...
  approval_name: 'Jane Doe', approval_role: 'SITE-ALPHA Operations Lead',
};

const CATALOGUE = {
  catalogue_id: 'b2b-portal', scope_name: 'tenant-one-b2b-use-case', title: 'B2B Portal Use Case Seed Data',
  date_readable: '17 Aug 2026', version: '1.0.0', author: 'Architect',
...
test('filename() uses each archetype declared primary/secondary slots', () => {
  ...
  assert.equal(f, 'site-alpha-mailbox_alex_v1_0_0_20260817.docx');
});
