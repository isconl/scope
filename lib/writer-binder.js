...
// KI26091201: tenant-identifying OneDrive path -- environment-supplied, never
// hardcoded. This repo is public; a literal path here leaks the owner's folder
// structure. Set SCOPE_BINDER_PATH in the deployment environment.
const BINDER_PATH = process.env.SCOPE_BINDER_PATH || null;
