...
function rootsFor(workspace, engineDir) {
  return [
    path.join(workspace, 'TenantOne', 'work-tasks'),
    path.join(workspace, 'TenantOne', 'work_tasks'),      // the folder on disk uses an underscore
    path.join(workspace, 'TenantOne', 'work-documents'),  // the weekly snapshots live here
    path.join(workspace, 'TenantOne', 'work-meetings'),
